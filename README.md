...
### 1️⃣ Initial Reduction

* Split the input:  

  * smaller elements → pushed to stack `b` ⬇️  
...
* ⚖️ **Perfect algorithms are not required**  
...
To validate that the output actually sorts the stack, use the official checker:  
...
### 📏 Operation Count (Performance Check)

Beyond correctness (`OK / KO`), the key metric of this project is the **number of operations** produced.  

📊 You can measure it using:  

```bash
ARG="3 2 1 6 5 4"; ./push_swap $ARG | wc -l
```

This returns the total number of instructions generated.  

### ⚠️ Tip

🎲 For better testing, generate random inputs:  
